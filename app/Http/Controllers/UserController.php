...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Users berhasil diambil', UserResource::collection($users), 200);
        } catch (\Exception $e) {
    ...
    { 
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data users berhasil diambil', PaginateResource::make($users, UserResource::class), 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
